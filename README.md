...
> [!IMPORTANT]
> 公開ベータ版は実装・実機検証済みです。VOCALOID6と初音ミク V6は利用者自身が正規に所有・インストールする必要があります。プラグインはボイスバンク、立ち絵素材、認証情報を同梱しません。
...
Phase 0からPhase 5まで、対応環境での実装・実機検証を通過済みです。詳細は[E2E検証証跡](docs/E2E_EVIDENCE.md)を参照してください。
